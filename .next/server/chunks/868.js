...
if (!globalThis.ReadableStream) {
    ...
    try {
        ...
        Object.assign(globalThis, __webpack_require__(5017));
    }
}
try {
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8863);
...
/* harmony import */ var node_domexception__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9321);
/* harmony import */ var _file_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(580);
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8863);
...
// @ts-ignore
const fromBlob = (stat, path, type = "")=>new Blob([
        new BlobDataItem({
            path,
            size: stat.size,
...
// @ts-ignore
const fromFile = (stat, path, type = "")=>new File([
        new BlobDataItem({
            path,
            size: stat.size,
            lastModified: stat.mtimeMs,
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9488);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8863);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(580);
...
var { toStringTag: t, iterator: i, hasInstance: h } = Symbol, r = Math.random, m = "append,set,get,getAll,delete,keys,values,entries,forEach,constructor".split(","), f = (a, b, c)=>(a += "", /^(Blob|File)$/.test(b && b[t]) ? [
        ...
        b.name !== c || b[t] == "blob" ? new fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z([
            b
        ], c, b) : b
    ] : [
        a,
...
/** @param {FormData} F */ function formDataToBlob(F, B = fetch_blob__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z) {
...
;// CONCATENATED MODULE: ./node_modules/node-fetch/node_modules/data-uri-to-buffer/dist/index.js
/**
...
/* harmony default export */ const dist = (dataUriToBuffer); //# sourceMappingURL=index.js.map

// EXTERNAL MODULE: external "node:util"
var external_node_util_ = __webpack_require__(7261);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __webpack_require__(8863);
// EXTERNAL MODULE: ./node_modules/formdata-polyfill/esm.min.js
var esm_min = __webpack_require__(1080);
 ...
 */ class Body {
    ...
    async formData() {
        ...
        const { toFormData } = await __webpack_require__.e(/* import() */ 819).then(__webpack_require__.bind(__webpack_require__, 2819));
	 ...
	 */ async blob() {
        ...
        return new fetch_blob/* default */.Z([
            buf
        ], {
            type: ct
        });
...
Object.defineProperties(Body.prototype, {
    ...
    data: {
        get: (0,external_node_util_.deprecate)(()=>{}, "data doesn't exist, use json(), text(), arrayBuffer(), or body instead", "https://github.com/node-fetch/node-fetch/issues/1000 (response)")
    }
});
/**
 ...
 */ async function consumeBody(data) {
    ...
    /* c8 ignore next 3 */ if (!(body instanceof external_node_stream_)) {
        return external_node_buffer_.Buffer.alloc(0);
    }
    // Body is stream
 ...
 */ const clone = (instance, highWaterMark)=>{
    ...
    if (body instanceof external_node_stream_ && typeof body.getBoundary !== "function") {
        // Tee instance body
        p1 = new external_node_stream_.PassThrough({
            highWaterMark
        });
        p2 = new external_node_stream_.PassThrough({
            highWaterMark
        });
        body.pipe(p1);
        body.pipe(p2);
...
const getNonSpecFormDataBoundary = (0,external_node_util_.deprecate)((body)=>body.getBoundary(), "form-data doesn't follow the spec and requires special treatment. Use alternative package", "https://github.com/node-fetch/node-fetch/issues/1167");
/**
...
/* c8 ignore next 9 */ const validateHeaderName = typeof external_node_http_.validateHeaderName === "function" ? external_node_http_.validateHeaderName : (name)=>{
    if (!/^[\^`\-\w!#$%&'*+.|~]+$/.test(name)) {
...
/* c8 ignore next 9 */ const validateHeaderValue = typeof external_node_http_.validateHeaderValue === "function" ? external_node_http_.validateHeaderValue : (name, value)=>{
    if (/[^\t\u0020-\u007E\u0080-\u00FF]/.test(value)) {
        ...
        // No op
            ...
            if (method == null) {
                ...
                result = [
                    ...
                    if (typeof pair !== "object" || external_node_util_.types.isBoxedPrimitive(pair)) {
...
const doBadDataWarn = (0,external_node_util_.deprecate)(()=>{}, ".data is not a valid RequestInit property, use .body instead", "https://github.com/node-fetch/node-fetch/issues/1000 (request)");
/**
 * Request class
 *
...
var from = __webpack_require__(9585);
    ...
    request.on("socket", (socket)=>{
        ...
        const onData = (buf)=>{
            ...
            if (!properLastChunkReceived && previousChunk) {
                properLastChunkReceived = external_node_buffer_.Buffer.compare(previousChunk.slice(-3), LAST_CHUNK.slice(0, 3)) === 0 && external_node_buffer_.Buffer.compare(buf.slice(-2), LAST_CHUNK.slice(3)) === 0;
            }
            previousChunk = buf;
        };
