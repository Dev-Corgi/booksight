...
// import reviewCrawlerAPI from "root/api/reviewCrawlerAPI";
import reviewCrawlerHandler from "@handler/reviewCrawlerHandler";
import Shimmer from "@/app/components/Simmer";

export default function ReviewContents({ book, index }) {
  ...
  return (
    <Shimmer isLoading={reviewData == undefined} className={"relative w-full h-full"}>
