  ...
  return (
      <div className={`${className} flex flex-col`}>
        ...
        <div className="relative w-full h-[250.51px]">
          <div className="absolute left-[652px] top-2 w-[626px] h-[338.98px]">
            <Image src={shadow2Img} className = "object-cover"></Image>
          </div>
          <div className="absolute flex flex-col w-full h-full ml-[28px] mt-[14px] rounded-[15px] bg-discriptionPanel">
            ...
            <div className="mt-[12.5px] ml-[19px] gap-[8px] w-min h-min flex flex-row items-center">
              <div className="flex items-center justify-center w-[13px] h-[13px]">
                <div className="w-[3.47px] h-[13px] rotate-90">
                  <Image src={MenuSVG} />
                </div>
              </div>
