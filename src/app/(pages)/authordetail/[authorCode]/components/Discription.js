...
export default function Discription({ authorDisc }) {
  ...
  return (
    <Shimmer isLoading={currentAuthorDisc == undefined} className={"flex"}>
      <div className=" flex flex-col justify-start items-center w-[643px] lg:w-[62.79vw] h-[155px] lg:h-[15.14vw] rounded-[10px] lg:rounded-[0.98vw] bg-background">
        <div className="flex flex-col justify-start items-start mx-[18px] my-[17px] overflow-y-scroll scroll no-scrollbar">
          <p className="font-NotoSansKRMedium text-[10px] lg:text-[0.98vw] whitespace-pre-wrap">
            {!isLoading ? currentAuthorDisc : defaultDisc}
          </p>
        </div>
      </div>
    </Shimmer>
